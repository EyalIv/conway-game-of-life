  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-12">
        ...
        >
          <div className="text-sm text-black/50 flex items-center justify-center gap-1.5">
            <span>Made with</span>
            <span className="text-red-500">❤️</span>
            <span>by</span>
            <a href="https://github.com/EyalIv" target="_blank" rel="noopener noreferrer" className="hover:text-black transition-colors underline decoration-black/20 hover:decoration-black/50">Eyal Ivri</a>
          </div>
        </motion.footer>
      </div>
